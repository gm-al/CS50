...
int compute_score(string word)
{
    ...
    for (int i = 0; i < strlen(word); i++)
    {
        ...
        if (isupper(word[i]))
        {
            // if the letter is upper find the words from capital_letters
        ...
        {
            // if the letter is small find the words from small_letters
        ...
        // if the word contains anything other than aplhabets
        else
        {
            i += 1;
        }
